...
#ifndef DUNE_PDELAB_IMEX_ONESTEP_HH
#define DUNE_PDELAB_IMEX_ONESTEP_HH
...
namespace Dune {
  namespace PDELab {
    ...
    public:
       ...
       * there).
       */
      IMEXOneStepMethod(const IMEXTimeSteppingParameterInterface<T>& method_,
       ...
       * function returns.
       */
      void setMethod (const IMEXTimeSteppingParameterInterface<T>& method_)
      {
        method = &method_;
      }
    ...
    private:
      ...
      const IMEXTimeSteppingParameterInterface<T> *method;
      IGOS& igos;
      PDESOLVER& pdesolver;
      int verbosityLevel;
      int step;
      Result res;
    }; // end class IMEXOneStepMethod
