...
#ifndef DUNE_PDELAB_IMEX_ONESTEP_ENGINEBASE_HH
#define DUNE_PDELAB_IMEX_ONESTEP_ENGINEBASE_HH

/**
 * \author Pavel Hron, Marian Piatkowski
 * \file
 * \brief Implementation of IMEXOneStepLocalAssemblerEngineBase
 */
...
namespace Dune {
  namespace PDELab {
    ...
    */
    template<typename OSLA, typename LAE0, typename LAE1, typename LAE2>
    class IMEXOneStepLocalAssemblerEngineBase
    {
    public:
      ...
      static const bool needs_constraints_caching =
        ...
        LAE2::needs_constraints_caching ;
      ...
      bool needsConstraintsCaching(const TrialConstraintsContainer& cu, const TestConstraintsContainer& cv) const
      {
        return
          ...
          lae2->needsConstraintsCaching(cu,cv);
      }
      ...
      typedef LAE2 LocalAssemblerEngineDT2;
      //! @}
      ...
      /**
         ...
         creates this engine
      */
      IMEXOneStepLocalAssemblerEngineBase(const LocalAssembler & local_assembler_)
        : invalid_lae0(static_cast<LocalAssemblerEngineDT0*>(0)),
          invalid_lae1(static_cast<LocalAssemblerEngineDT1*>(0)),
          invalid_lae2(static_cast<LocalAssemblerEngineDT2*>(0)),
          la(local_assembler_),
          lae0(invalid_lae0), lae1(invalid_lae1), lae2(invalid_lae2),
          implicit(true)
      {}
      ...
      { return implicit && (lae0->requireSkeleton() || lae1->requireSkeleton() || lae2->requireSkeleton()); }
      bool requireSkeletonTwoSided() const
      { return lae0->requireSkeletonTwoSided() || lae1->requireSkeletonTwoSided() || lae2->requireSkeletonTwoSided(); }
      bool requireUVVolume() const
      { return lae0->requireUVVolume() || lae1->requireUVVolume() || lae2->requireUVVolume(); }
      bool requireVVolume() const
      { return lae0->requireVVolume() || lae1->requireVVolume() || lae2->requireVVolume(); }
      bool requireUVSkeleton() const
      { return lae0->requireUVSkeleton() || lae1->requireUVSkeleton()|| lae2->requireUVSkeleton() ; }
      bool requireVSkeleton() const
      { return lae0->requireVSkeleton() || lae1->requireVSkeleton()|| lae2->requireVSkeleton(); }
      bool requireUVBoundary() const
      { return lae0->requireUVBoundary() || lae1->requireUVBoundary()|| lae2->requireUVBoundary(); }
      bool requireVBoundary() const
      { return lae0->requireVBoundary() || lae1->requireVBoundary()|| lae2->requireVBoundary(); }
      bool requireUVProcessor() const
      { return lae0->requireUVProcessor() || lae1->requireUVProcessor()|| lae2->requireUVProcessor(); }
      bool requireVProcessor() const
      { return lae0->requireVProcessor() || lae1->requireVProcessor()|| lae2->requireVProcessor(); }
      bool requireUVEnrichedCoupling() const
      { return lae0->requireUVEnrichedCoupling() || lae1->requireUVEnrichedCoupling()|| lae2->requireUVEnrichedCoupling(); }
      bool requireVEnrichedCoupling() const
      { return lae0->requireVEnrichedCoupling() || lae1->requireVEnrichedCoupling()|| lae2->requireVEnrichedCoupling(); }
      bool requireUVVolumePostSkeleton() const
      { return lae0->requireUVVolumePostSkeleton() || lae1->requireUVVolumePostSkeleton()|| lae2->requireUVVolumePostSkeleton();}
      bool requireVVolumePostSkeleton() const
      { return lae0->requireVVolumePostSkeleton() || lae1->requireVVolumePostSkeleton()|| lae2->requireVVolumePostSkeleton(); }
      //! @}
      ...
      LocalAssemblerEngineDT2& localAssemblerEngineDT2()
      {
        return *lae2;
      }

      const LocalAssemblerEngineDT2& localAssemblerEngineDT2() const
      {
        return *lae2;
      }
      ...
      void setLocalAssemblerEngineDT2(LocalAssemblerEngineDT2& lae2_)
      {
        lae2 = &lae2_;
      }

      const typename IMEXOneStepLocalAssembler::Traits::TrialGridFunctionSpaceConstraints& trialConstraints() const
      {
        return localAssemblerEngineDT0().trialConstraints();
      }

      const typename IMEXOneStepLocalAssembler::Traits::TestGridFunctionSpaceConstraints& testConstraints() const
      {
      ...
      void onBindLFSUVInside(const IG & ig, const LFSU & lfsu, const LFSV & lfsv){
        ...
        lae2->onBindLFSUVInside(ig,lfsu,lfsv);
      }
      ...
      void onBindLFSUVOutside(const IG & ig,
        ...
        lae2->onBindLFSUVOutside(ig,lfsu_s,lfsv_s,lfsu_n,lfsv_n);
      }
      ...
      void onBindLFSVOutside(const IG & ig,
        ...
        lae2->onBindLFSVOutside(ig,lfsv_s,lfsv_n);
      }
      ...
      void onBindLFSVCoupling(const IG & ig,
        ...
        lae2->onBindLFSVCoupling(ig,lfsv_s,lfsv_n,lfsv_c);
      }
      ...
      void onUnbindLFSUV(const EG & eg, const LFSU & lfsu, const LFSV & lfsv){
        ...
        lae2->onUnbindLFSUV(eg,lfsu, lfsv);
      }
      ...
      void onUnbindLFSUVInside(const IG & ig, const LFSU & lfsu, const LFSV & lfsv){
        ...
        lae2->onUnbindLFSUVInside(ig,lfsu, lfsv);
      }
      ...
      void onUnbindLFSUVOutside(const IG & ig,
        ...
        lae2->onUnbindLFSUVOutside(ig,lfsu_s,lfsv_s,lfsu_n,lfsv_n);
      }
      ...
      void onUnbindLFSVInside(const IG & ig, const LFSV & lfsv){
        ...
        lae2->onUnbindLFSVInside(ig,lfsv);
      }
      ...
      void onUnbindLFSVOutside(const IG & ig,
        ...
        lae2->onUnbindLFSVOutside(ig,lfsv_s,lfsv_n);
      }
      ...
      void onUnbindLFSVCoupling(const IG & ig,
        ...
        lae2->onUnbindLFSVCoupling(ig,lfsv_s,lfsv_n,lfsv_c);
      }
      ...
      void loadCoefficientsLFSUInside(const LFSU & lfsu_s){
        ...
        lae2->loadCoefficientsLFSUInside(lfsu_s);
      }
      template<typename LFSU>
      void loadCoefficientsLFSUOutside(const LFSU & lfsu_n){
        ...
        lae2->loadCoefficientsLFSUOutside(lfsu_n);
      }
      template<typename LFSU>
      void loadCoefficientsLFSUCoupling(const LFSU & lfsu_c){
        ...
        lae2->loadCoefficientsLFSUCoupling(lfsu_c);
      }
      //! @}
      ...
      void assembleUVVolume(const EG & eg, const LFSU & lfsu, const LFSV & lfsv)
      {
        ...
        lae2->assembleUVVolume(eg,lfsu,lfsv);
      }
                              ...
                              const LFSU_N & lfsu_n, const LFSV_N & lfsv_n)
      {
        ...
        lae2->assembleUVSkeleton(ig,lfsu_s,lfsv_s,lfsu_n,lfsv_n);
      }
      ...
      void assembleVSkeleton(const IG & ig, const LFSV_S & lfsv_s, const LFSV_N & lfsv_n)
      {
        ...
        lae2->assembleVSkeleton(ig,lfsv_s,lfsv_n);
      }
      ...
      void assembleUVBoundary(const IG & ig, const LFSU_S & lfsu_s, const LFSV_S & lfsv_s)
      {
        ...
        lae2->assembleUVBoundary(ig,lfsu_s,lfsv_s);
      }
      ...
      void assembleVBoundary(const IG & ig, const LFSV_S & lfsv_s)
      {
        ...
        lae2->assembleVBoundary(ig,lfsv_s);
      }
      ...
      void assembleUVProcessor(const IG & ig, const LFSU_S & lfsu_s, const LFSV_S & lfsv_s)
      {
        ...
        lae2->assembleUVProcessor(ig,lfsu_s,lfsv_s);
      }
      ...
      void assembleVProcessor(const IG & ig, const LFSV_S & lfsv_s)
      {
        ...
        lae2->assembleVProcessor(ig,lfsv_s);
      }
                                      ...
                                      const LFSU_C & lfsu_c, const LFSV_C & lfsv_c)
      {
        ...
        lae2->assembleUVEnrichedCoupling(ig,lfsu_s,lfsv_s,lfsu_n,lfsv_n,lfsu_c,lfsv_c);
      }
    ...
    private:
      ...
      LocalAssemblerEngineDT2 * const invalid_lae2;
    ...
    protected:
      ...
      LocalAssemblerEngineDT2 * lae2;

      bool implicit;

    }; // end class IMEXOneStepLocalAssemblerEngineBase
