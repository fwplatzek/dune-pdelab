...
#ifndef DUNE_PDELAB_MULTISTEP_ENGINEBASE_HH
#define DUNE_PDELAB_MULTISTEP_ENGINEBASE_HH

/**
 * \author Marian Piatkowski
 * \file
 * \brief Implementation of the MultiStepLocalAssemblerEngineBase
 */

//============================================
// TODO
// For n grid-operators we need to have n local assembler engines
// lae0, ..., lae"n-1".
// All these engines need to be called where the current engines
// lae0 and lae1 are called.
// Possible changes are located at the constructor of this class
// and beginning at the function "requireSkeleton" to the end of this class.
//============================================
...
namespace Dune {
  namespace PDELab {
    ...
    */
    ...
    template<typename MSLA, typename LAE0, typename LAE1>
    class MultiStepLocalAssemblerEngineBase
    {
    public :
      //! The type of the wrapping local assembler
      typedef MSLA MultiStepLocalAssembler;
      ...
      //============================================
      // TODO
      // higher order problems with more than two grid-operators
      //============================================
      //! @{
      ...
      /**
         ...
         creates this engine
      */
      MultiStepLocalAssemblerEngineBase(const LocalAssembler & local_assembler_)
      ...
      const typename MultiStepLocalAssembler::Traits::TrialGridFunctionSpaceConstraints& trialConstraints() const
      {
        return localAssemblerEngineDT0().trialConstraints();
      }

      const typename MultiStepLocalAssembler::Traits::TestGridFunctionSpaceConstraints& testConstraints() const
      {
    ...
    protected:
      ...
      bool implicit;
    }; // end class MultiStepLocalAssemblerEngineBase
